...
private:
    ...
    // inline void I2CInit() { i2c.Init(); }
    // inline void I2CWriteBytes(const uint8_t *data, uint8_t len) { i2c.WriteBytes(device_addr, data, len); };
    // inline void I2CReadBytes(uint8_t *data, uint8_t len) { i2c.ReadBytes(device_addr, data, len); };
