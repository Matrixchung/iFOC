#ifndef _FOC_MOTOR_CONFIG_DCU08017P12_H
#define _FOC_MOTOR_CONFIG_DCU08017P12_H

#include "foc_config_type.h"

static foc_config_t config_dcu08017p12 = 
{
    .motor = 
    {
        .Rs = 0.0f,
    ...
    .current_pid = {0.1f, 7000.0f, 0.0f, 12.0f, 0.0f},
