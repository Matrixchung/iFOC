...
bool uavcan_equipment_indication_SingleLightCommand_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_equipment_indication_SingleLightCommand* msg);
...
static inline bool _uavcan_equipment_indication_SingleLightCommand_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_equipment_indication_SingleLightCommand* msg, bool tao);
void _uavcan_equipment_indication_SingleLightCommand_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_equipment_indication_SingleLightCommand* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 8, &msg->light_id);
    *bit_ofs += 8;
...
*/
bool _uavcan_equipment_indication_SingleLightCommand_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_equipment_indication_SingleLightCommand* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 8, false, &msg->light_id);
    *bit_ofs += 8;
