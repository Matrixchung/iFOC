...
bool uavcan_Timestamp_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_Timestamp* msg);

#if defined(CANARD_DSDLC_INTERNAL)
static inline void _uavcan_Timestamp_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_Timestamp* msg, bool tao);
static inline bool _uavcan_Timestamp_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_Timestamp* msg, bool tao);
void _uavcan_Timestamp_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_Timestamp* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 56, &msg->usec);
    *bit_ofs += 56;
}
...
*/
bool _uavcan_Timestamp_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_Timestamp* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 56, false, &msg->usec);
    *bit_ofs += 56;
