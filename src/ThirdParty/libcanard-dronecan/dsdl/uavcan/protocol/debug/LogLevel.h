...
bool uavcan_protocol_debug_LogLevel_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_debug_LogLevel* msg);
...
static inline bool _uavcan_protocol_debug_LogLevel_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_debug_LogLevel* msg, bool tao);
void _uavcan_protocol_debug_LogLevel_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_debug_LogLevel* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 3, &msg->value);
    *bit_ofs += 3;
}
...
*/
bool _uavcan_protocol_debug_LogLevel_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_debug_LogLevel* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 3, false, &msg->value);
    *bit_ofs += 3;
