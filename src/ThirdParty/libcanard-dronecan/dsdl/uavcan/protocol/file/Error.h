...
bool uavcan_protocol_file_Error_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_file_Error* msg);
...
static inline bool _uavcan_protocol_file_Error_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_file_Error* msg, bool tao);
void _uavcan_protocol_file_Error_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_file_Error* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 16, &msg->value);
    *bit_ofs += 16;
}
...
*/
bool _uavcan_protocol_file_Error_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_file_Error* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 16, true, &msg->value);
    *bit_ofs += 16;
