...
bool uavcan_protocol_file_GetInfoRequest_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_file_GetInfoRequest* msg);
...
static inline bool _uavcan_protocol_file_GetInfoRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_file_GetInfoRequest* msg, bool tao);
...
*/
bool _uavcan_protocol_file_GetInfoRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_file_GetInfoRequest* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
