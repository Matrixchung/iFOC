...
bool uavcan_protocol_file_BeginFirmwareUpdateResponse_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_file_BeginFirmwareUpdateResponse* msg);
...
static inline bool _uavcan_protocol_file_BeginFirmwareUpdateResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_file_BeginFirmwareUpdateResponse* msg, bool tao);
...
#pragma GCC diagnostic pop
    if (!tao) {
        DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 7, &optional_error_message_len);
        *bit_ofs += 7;
    }
    for (size_t i=0; i < optional_error_message_len; i++) {
        DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 8, &msg->optional_error_message.data[i]);
        *bit_ofs += 8;
    }
}
...
*/
bool _uavcan_protocol_file_BeginFirmwareUpdateResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_file_BeginFirmwareUpdateResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    ...
    *bit_ofs += 8;
    ...
    if (!tao) {
        DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 7, false, &msg->optional_error_message.len);
        *bit_ofs += 7;
    } else {
...
#pragma GCC diagnostic pop
    for (size_t i=0; i < msg->optional_error_message.len; i++) {
        DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 8, false, &msg->optional_error_message.data[i]);
        *bit_ofs += 8;
    }
