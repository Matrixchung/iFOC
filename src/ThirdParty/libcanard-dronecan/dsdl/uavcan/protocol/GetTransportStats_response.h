...
bool uavcan_protocol_GetTransportStatsResponse_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_GetTransportStatsResponse* msg);
...
static inline bool _uavcan_protocol_GetTransportStatsResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_GetTransportStatsResponse* msg, bool tao);
void _uavcan_protocol_GetTransportStatsResponse_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_GetTransportStatsResponse* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 48, &msg->transfers_tx);
    *bit_ofs += 48;
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 48, &msg->transfers_rx);
    *bit_ofs += 48;
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 48, &msg->transfer_errors);
    *bit_ofs += 48;
...
#pragma GCC diagnostic pop
    if (!tao) {
        DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 2, &can_iface_stats_len);
        *bit_ofs += 2;
    }
...
*/
bool _uavcan_protocol_GetTransportStatsResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_GetTransportStatsResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 48, false, &msg->transfers_tx);
    *bit_ofs += 48;

    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 48, false, &msg->transfers_rx);
    *bit_ofs += 48;

    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 48, false, &msg->transfer_errors);
    *bit_ofs += 48;

    if (!tao) {
        DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 2, false, &msg->can_iface_stats.len);
        *bit_ofs += 2;
    }
