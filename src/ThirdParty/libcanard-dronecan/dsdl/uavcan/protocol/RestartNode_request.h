...
bool uavcan_protocol_RestartNodeRequest_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_RestartNodeRequest* msg);
...
static inline bool _uavcan_protocol_RestartNodeRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_RestartNodeRequest* msg, bool tao);
void _uavcan_protocol_RestartNodeRequest_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_RestartNodeRequest* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 40, &msg->magic_number);
    *bit_ofs += 40;
}
...
*/
bool _uavcan_protocol_RestartNodeRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_RestartNodeRequest* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 40, false, &msg->magic_number);
    *bit_ofs += 40;
