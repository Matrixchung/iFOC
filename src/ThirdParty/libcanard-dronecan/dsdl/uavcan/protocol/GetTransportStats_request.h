...
bool uavcan_protocol_GetTransportStatsRequest_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_GetTransportStatsRequest* msg);
...
static inline bool _uavcan_protocol_GetTransportStatsRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_GetTransportStatsRequest* msg, bool tao);
...
*/
bool _uavcan_protocol_GetTransportStatsRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_GetTransportStatsRequest* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
