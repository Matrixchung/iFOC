...
bool uavcan_protocol_dynamic_node_id_server_RequestVoteRequest_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_dynamic_node_id_server_RequestVoteRequest* msg);
...
static inline bool _uavcan_protocol_dynamic_node_id_server_RequestVoteRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_dynamic_node_id_server_RequestVoteRequest* msg, bool tao);
void _uavcan_protocol_dynamic_node_id_server_RequestVoteRequest_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_dynamic_node_id_server_RequestVoteRequest* msg, bool tao) {
    ...
    *bit_ofs += 32;
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 32, &msg->last_log_term);
    *bit_ofs += 32;
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 8, &msg->last_log_index);
    *bit_ofs += 8;
}
...
*/
bool _uavcan_protocol_dynamic_node_id_server_RequestVoteRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_dynamic_node_id_server_RequestVoteRequest* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    ...
    *bit_ofs += 32;
    ...
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 32, false, &msg->last_log_term);
    *bit_ofs += 32;

    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 8, false, &msg->last_log_index);
    *bit_ofs += 8;
