...
bool uavcan_protocol_dynamic_node_id_server_AppendEntriesResponse_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_dynamic_node_id_server_AppendEntriesResponse* msg);
...
static inline bool _uavcan_protocol_dynamic_node_id_server_AppendEntriesResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_dynamic_node_id_server_AppendEntriesResponse* msg, bool tao);
void _uavcan_protocol_dynamic_node_id_server_AppendEntriesResponse_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_dynamic_node_id_server_AppendEntriesResponse* msg, bool tao) {
    ...
    *bit_ofs += 32;
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 1, &msg->success);
    *bit_ofs += 1;
}
...
*/
bool _uavcan_protocol_dynamic_node_id_server_AppendEntriesResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_dynamic_node_id_server_AppendEntriesResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    ...
    *bit_ofs += 32;
    ...
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 1, false, &msg->success);
    *bit_ofs += 1;
