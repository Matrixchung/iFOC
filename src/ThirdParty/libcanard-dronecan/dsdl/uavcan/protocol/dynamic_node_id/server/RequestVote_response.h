...
bool uavcan_protocol_dynamic_node_id_server_RequestVoteResponse_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_dynamic_node_id_server_RequestVoteResponse* msg);
...
static inline bool _uavcan_protocol_dynamic_node_id_server_RequestVoteResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_dynamic_node_id_server_RequestVoteResponse* msg, bool tao);
void _uavcan_protocol_dynamic_node_id_server_RequestVoteResponse_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_dynamic_node_id_server_RequestVoteResponse* msg, bool tao) {
    ...
    *bit_ofs += 32;
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 1, &msg->vote_granted);
    *bit_ofs += 1;
}
...
*/
bool _uavcan_protocol_dynamic_node_id_server_RequestVoteResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_dynamic_node_id_server_RequestVoteResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    ...
    *bit_ofs += 32;
    ...
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 1, false, &msg->vote_granted);
    *bit_ofs += 1;
