...
bool uavcan_protocol_AccessCommandShellResponse_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_AccessCommandShellResponse* msg);
...
static inline bool _uavcan_protocol_AccessCommandShellResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_AccessCommandShellResponse* msg, bool tao);
void _uavcan_protocol_AccessCommandShellResponse_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_AccessCommandShellResponse* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 32, &msg->last_exit_status);
    *bit_ofs += 32;
...
#pragma GCC diagnostic pop
    if (!tao) {
        DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 9, &output_len);
        *bit_ofs += 9;
    }
    for (size_t i=0; i < output_len; i++) {
        DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 8, &msg->output.data[i]);
        *bit_ofs += 8;
    }
}
...
*/
bool _uavcan_protocol_AccessCommandShellResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_AccessCommandShellResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 32, true, &msg->last_exit_status);
    *bit_ofs += 32;
    ...
    *bit_ofs += 8;
    ...
    if (!tao) {
        DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 9, false, &msg->output.len);
        *bit_ofs += 9;
    } else {
...
#pragma GCC diagnostic pop
    for (size_t i=0; i < msg->output.len; i++) {
        DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 8, false, &msg->output.data[i]);
        *bit_ofs += 8;
    }
