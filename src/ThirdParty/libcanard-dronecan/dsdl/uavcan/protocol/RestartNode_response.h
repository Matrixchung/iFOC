...
bool uavcan_protocol_RestartNodeResponse_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_RestartNodeResponse* msg);
...
static inline bool _uavcan_protocol_RestartNodeResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_RestartNodeResponse* msg, bool tao);
...
*/
bool _uavcan_protocol_RestartNodeResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_RestartNodeResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
