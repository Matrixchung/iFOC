...
bool uavcan_protocol_DataTypeKind_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_DataTypeKind* msg);
...
static inline bool _uavcan_protocol_DataTypeKind_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_DataTypeKind* msg, bool tao);
void _uavcan_protocol_DataTypeKind_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_DataTypeKind* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 8, &msg->value);
    *bit_ofs += 8;
}
...
*/
bool _uavcan_protocol_DataTypeKind_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_DataTypeKind* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 8, false, &msg->value);
    *bit_ofs += 8;
