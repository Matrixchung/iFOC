...
bool uavcan_protocol_param_ExecuteOpcodeResponse_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_param_ExecuteOpcodeResponse* msg);
...
static inline bool _uavcan_protocol_param_ExecuteOpcodeResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_param_ExecuteOpcodeResponse* msg, bool tao);
void _uavcan_protocol_param_ExecuteOpcodeResponse_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_param_ExecuteOpcodeResponse* msg, bool tao) {
    ...
    *bit_ofs += 48;
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 1, &msg->ok);
    *bit_ofs += 1;
}
...
*/
bool _uavcan_protocol_param_ExecuteOpcodeResponse_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_param_ExecuteOpcodeResponse* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    ...
    *bit_ofs += 48;
    ...
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 1, false, &msg->ok);
    *bit_ofs += 1;
