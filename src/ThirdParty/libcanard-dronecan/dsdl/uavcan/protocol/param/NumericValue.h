...
bool uavcan_protocol_param_NumericValue_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_param_NumericValue* msg);
...
static inline bool _uavcan_protocol_param_NumericValue_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_param_NumericValue* msg, bool tao);
void _uavcan_protocol_param_NumericValue_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_param_NumericValue* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 2, &union_tag);
    *bit_ofs += 2;
...
*/
bool _uavcan_protocol_param_NumericValue_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_param_NumericValue* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    uint8_t union_tag;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 2, false, &union_tag);
    *bit_ofs += 2;
