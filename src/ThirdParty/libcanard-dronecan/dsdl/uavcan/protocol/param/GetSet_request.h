...
bool uavcan_protocol_param_GetSetRequest_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_param_GetSetRequest* msg);
...
static inline bool _uavcan_protocol_param_GetSetRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_param_GetSetRequest* msg, bool tao);
void _uavcan_protocol_param_GetSetRequest_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_param_GetSetRequest* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 13, &msg->index);
    *bit_ofs += 13;
...
*/
bool _uavcan_protocol_param_GetSetRequest_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_param_GetSetRequest* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 13, false, &msg->index);
    *bit_ofs += 13;
