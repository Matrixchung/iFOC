...
bool uavcan_protocol_param_Value_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_protocol_param_Value* msg);
...
static inline bool _uavcan_protocol_param_Value_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_param_Value* msg, bool tao);
void _uavcan_protocol_param_Value_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_protocol_param_Value* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 3, &union_tag);
    *bit_ofs += 3;
    ...
    switch(msg->union_tag) {
        ...
        case UAVCAN_PROTOCOL_PARAM_VALUE_INTEGER_VALUE: {
            DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 64, &msg->integer_value);
            *bit_ofs += 64;
            break;
        }
        case UAVCAN_PROTOCOL_PARAM_VALUE_REAL_VALUE: {
            DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 32, &msg->real_value);
            *bit_ofs += 32;
            break;
        }
        case UAVCAN_PROTOCOL_PARAM_VALUE_BOOLEAN_VALUE: {
            DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 8, &msg->boolean_value);
            *bit_ofs += 8;
            break;
        }
...
#pragma GCC diagnostic pop
            if (!tao) {
                DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 8, &string_value_len);
                *bit_ofs += 8;
            }
            for (size_t i=0; i < string_value_len; i++) {
                DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 8, &msg->string_value.data[i]);
                *bit_ofs += 8;
            }
            break;
        }
...
*/
bool _uavcan_protocol_param_Value_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_protocol_param_Value* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    uint8_t union_tag;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 3, false, &union_tag);
    *bit_ofs += 3;
#pragma GCC diagnostic push
#pragma GCC diagnostic ignored "-Wtype-limits"
    if (union_tag >= 5) {
...
#pragma GCC diagnostic pop
    ...
    switch(msg->union_tag) {
        ...
        case UAVCAN_PROTOCOL_PARAM_VALUE_INTEGER_VALUE: {
            DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 64, true, &msg->integer_value);
            *bit_ofs += 64;
            break;
        }

        case UAVCAN_PROTOCOL_PARAM_VALUE_REAL_VALUE: {
            DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 32, true, &msg->real_value);
            *bit_ofs += 32;
            break;
        }

        case UAVCAN_PROTOCOL_PARAM_VALUE_BOOLEAN_VALUE: {
            DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 8, false, &msg->boolean_value);
            *bit_ofs += 8;
            break;
        }
        ...
        case UAVCAN_PROTOCOL_PARAM_VALUE_STRING_VALUE: {
            if (!tao) {
                DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 8, false, &msg->string_value.len);
                *bit_ofs += 8;
            } else {
...
#pragma GCC diagnostic pop
            for (size_t i=0; i < msg->string_value.len; i++) {
                DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 8, false, &msg->string_value.data[i]);
                *bit_ofs += 8;
            }
            break;
        }
