...
bool uavcan_tunnel_Protocol_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_tunnel_Protocol* msg);
...
static inline bool _uavcan_tunnel_Protocol_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_tunnel_Protocol* msg, bool tao);
void _uavcan_tunnel_Protocol_encode(uint8_t* buffer, uint32_t* bit_ofs, struct uavcan_tunnel_Protocol* msg, bool tao) {
    ...
    DroneCAN::canardEncodeScalar(buffer, *bit_ofs, 8, &msg->protocol);
    *bit_ofs += 8;
}
...
*/
bool _uavcan_tunnel_Protocol_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_tunnel_Protocol* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
    DroneCAN::canardDecodeScalar(transfer, *bit_ofs, 8, false, &msg->protocol);
    *bit_ofs += 8;
