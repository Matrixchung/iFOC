...
bool uavcan_tunnel_Broadcast_decode(const DroneCAN::CanardRxTransfer* transfer, struct uavcan_tunnel_Broadcast* msg);
...
static inline bool _uavcan_tunnel_Broadcast_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_tunnel_Broadcast* msg, bool tao);
...
*/
bool _uavcan_tunnel_Broadcast_decode(const DroneCAN::CanardRxTransfer* transfer, uint32_t* bit_ofs, struct uavcan_tunnel_Broadcast* msg, bool tao) {
    (void)transfer;
    (void)bit_ofs;
    (void)msg;
    (void)tao;
