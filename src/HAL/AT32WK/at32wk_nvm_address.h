...
#define FLASH_USER_START_ADDR   (ADDR_FLASH_SECTOR_496)
#define FLASH_BL_START_ADDR     (ADDR_FLASH_SECTOR_0)
#define FLASH_APP_START_ADDR    (ADDR_FLASH_SECTOR_16) // 32K Bootloader
#define FLASH_USER_AREA_SIZE    (16 * FLASH_SECTOR_SIZE_BYTES)
#define USE_FLASHDB
#endif

#if defined(AT32F435xG) // 1024K, Single Bank, 2Kbytes per sector!!
#define ADDR_FLASH_SECTOR_0   ((uint32_t)0x8000000) /* Base @ of Sector 0  , 2 Kbytes */
#define ADDR_FLASH_SECTOR_1   ((uint32_t)0x8000800) /* Base @ of Sector 1  , 2 Kbytes */
#define ADDR_FLASH_SECTOR_2   ((uint32_t)0x8001000) /* Base @ of Sector 2  , 2 Kbytes */
#define ADDR_FLASH_SECTOR_3   ((uint32_t)0x8001800) /* Base @ of Sector 3  , 2 Kbytes */
...
#if defined(AT32F456xE) // 512K, Single Bank, 2Kbytes per sector
#define ADDR_FLASH_SECTOR_0   ((uint32_t)0x8000000) /* Base @ of Sector 0  , 2 Kbytes */
#define ADDR_FLASH_SECTOR_1   ((uint32_t)0x8000800) /* Base @ of Sector 1  , 2 Kbytes */
#define ADDR_FLASH_SECTOR_2   ((uint32_t)0x8001000) /* Base @ of Sector 2  , 2 Kbytes */
#define ADDR_FLASH_SECTOR_3   ((uint32_t)0x8001800) /* Base @ of Sector 3  , 2 Kbytes */
...
#define FLASH_WRITE_GRAN_BITS   (32) // WORD
#define FLASH_SECTOR_SIZE_BYTES (1024 * 2)
#define FLASH_USER_START_ADDR   (ADDR_FLASH_SECTOR_240)
#define FLASH_BL_START_ADDR     (ADDR_FLASH_SECTOR_0)
#define FLASH_APP_START_ADDR    (ADDR_FLASH_SECTOR_16) // 32K Bootloader
#define FLASH_USER_AREA_SIZE    (16 * FLASH_SECTOR_SIZE_BYTES)
#define USE_FLASHDB
