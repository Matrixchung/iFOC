...
void MX_TIM1_Init(void)
{
  ...
  */
  ...
  LL_GPIO_Init(PWM_AUX2_GPIO_Port, &GPIO_InitStruct);
...
void MX_TIM2_Init(void)
{
  ...
  TIM_InitStruct.Prescaler = 72-LL_TIM_IC_FILTER_FDIV1_N2;
  TIM_InitStruct.CounterMode = LL_TIM_COUNTERMODE_UP;
  TIM_InitStruct.Autoreload = 400-LL_TIM_IC_FILTER_FDIV1_N2;
  TIM_InitStruct.ClockDivision = LL_TIM_CLOCKDIVISION_DIV1;
...
void MX_TIM3_Init(void)
{
  ...
  LL_APB2_GRP1_EnableClock(LL_APB2_GRP1_PERIPH_GPIOB);
    ...
    PB4     ------> TIM3_CH1
    */
  GPIO_InitStruct.Pin = DRV_IN2_Pin|DRV_IN3_Pin|DRV_IN1_Pin;
