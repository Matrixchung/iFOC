...
User/Delay/delay.c \
User/Encoder/pwm_encoder.c \
User/Encoder/spi_encoder.c \
User/FOC/DRV8313.c \
User/FOC/foc.c \
User/FOC/lowpass_filter.c \
User/FOC/pid.c \
...
CFLAGS += -Wall -Wpointer-sign -fdata-sections -ffunction-sections 
ASFLAGS += -Wall -Wpointer-sign -fdata-sections -ffunction-sections 
CXXFLAGS += 
...
ADDITIONALLDFLAGS = -Wpointer-sign -specs=nano.specs -u_printf_float 
...
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/OPENOCD-20230712-0.12.0/BIN/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f1x mass_erase 0; exit"
