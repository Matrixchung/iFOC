...
c.set_bus_overvoltage_limit(60.0f);  \
c.set_bus_undervoltage_limit(8.0f);  \
c.set_bus_max_positive_current(80.0f);      \
c.set_bus_max_negative_current(-10.0f);      \
c.set_bus_sense_shunt_ohm(0.001f);   \
c.set_max_regen_current(10.0f);      \
c.set_current_sense_gain(10.0f);      \
c.set_current_sense_shunt_ohm(0.005f);       \
c.set_current_sense_f_lp(10000);      \
