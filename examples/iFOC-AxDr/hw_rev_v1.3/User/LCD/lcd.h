...
#define LCD_RES_Clr()  LL_GPIO_ResetOutputPin(LCD_RES_GPIO_Port,LCD_RES_Pin)
#define LCD_RES_Set()  LL_GPIO_SetOutputPin(LCD_RES_GPIO_Port,LCD_RES_Pin)

#define LCD_DC_Clr()   LL_GPIO_ResetOutputPin(LCD_DC_GPIO_Port,LCD_DC_Pin)
...
#define LCD_BLK_Clr()  LL_GPIO_ResetOutputPin(LCD_BLK_GPIO_Port,LCD_BLK_Pin)//BLK
#define LCD_BLK_Set()  LL_GPIO_ResetOutputPin(LCD_BLK_GPIO_Port,LCD_BLK_Pin)
